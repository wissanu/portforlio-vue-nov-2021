    ...
    <div class="product-container">
      <div class="product-card" v-for="product in products" :key="product.id">
        ...
        <div class="pro-content">
          ...
          <p>คงเหลือ:</p>
          <input type="text" :value="product.remaining" />
          <p>ราคาต้นทุน:</p>
...
.product-container .product-card .pro-img img {
  position: relative;
